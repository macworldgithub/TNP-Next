    ...
    return (
        <div className="  bg-white mx-auto flex flex-col lg:flex-row lg:items-center justify-center  my-16 w-[90%]">
            ...
            <div className="lg:w-1/2 lg:pl-8">
                <h2 className="text-2xl font-bold mb-4 text-center lg:text-left ">We have been in Tourism  <br></br> <span className='text-blue-500'> industry</span>   for more than 20 years</h2>
                ...
                <div className='flex  w-full gap-5 my-4'>
                    ...
                    <div className='flex flex-col'>
                        <h4 className='text-blue-600 font-semibold'>Book With Confident</h4>
                ...
                <div className='flex  w-full gap-5 my-4'>
                    ...
                    <div className='flex flex-col'>
                        <h4 className='text-blue-600 font-semibold'>Freedom to discover, confidence to explore</h4>
                        <p>Each trip is carefully crafted to leave you free to live in the moment
                            and enjoy your vacation.</p>
                ...
                <div className='flex  w-full gap-5 my-4'>
                    ...
                    <div className='flex flex-col'>
                        <h4 className='text-blue-600 font-semibold'>Dive into Culture</h4>
                        <p>Each trip is carefully crafted to leave you free to live in the moment
                            and enjoy your vacation.</p>
                ...
                <div className='flex justify-center lg:justify-normal items-center'>
                    ...
                    <button className="bg-blue-600 text-white py-2 px-5 rounded">BOOK NOW </button>
                </div>
            </div>
        </div>
    );
