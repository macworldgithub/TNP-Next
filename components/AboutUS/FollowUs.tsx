  ...
  return (
    <div className="lg:w-[85%] flex flex-col lg:flex-row gap-2 justify-center items-center mx-auto my-16 ">
      <div className="lg:w-[33%] relative ">
        ...
        <div className="flex  relative item-center justify-center items-center  ">
          <div className="lg:w-[4rem] w-[3rem] h-[2px] bg-gray-400 my-auto  "></div>
          <h1 className="text-1xl text-gray-400 mx-1 uppercase ">About Us</h1>
          <div className="lg:w-[4rem] w-[3rem] h-[2px] bg-gray-400 my-auto"></div>
        </div>
        <div>
          <p>
            Tours Dubai is a young and exciting Destination management company
            based in Dubai. The company is recognized for professionalism,
            impressive operational infrastructure, personalized service and
            creative itineraries which enable us to provide clients with the
