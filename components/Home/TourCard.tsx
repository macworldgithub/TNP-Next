...
const TourCard:React.FC<TourCardProps> = ({pic , loc , title , duration , people , price , dprice , review})=>{
    ...
    return(
        <div className="flex flex-col bg-white  md:h-[18rem] xl:h-auto h-auto items-center justify-center lg:w-[40%] xl:w-[30%] md:w-[40%] w-[90%] shadow-lg shadow-gray-400 rounded-lg">
