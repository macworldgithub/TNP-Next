        ...
        <header className="w-full text-sm flex justify-between px-10 bg-white">
            ...
            <div className="bg-white-500 relative w-3/5">
                <div className="text-black items-center py-2  h-full w-full justify-around flex">
                    ...
                    <div onMouseOver={() => setShowTourDropdown(true)} className='relative cursor-pointer font-bold'>
                        <p  >Tour</p>
                        <div onMouseOut={() => setShowTourDropdown(false)} className={` ${showTourDropdown ? "" : "w-0 overflow-hidden"} expansion absolute z-[100] top-[40px] left-[-5px]`}>
                            <div className=' bg-white h-[8.5rem] w-max flex rounded mt-8 py-2 px-4 shadow-md'>
                                <ul>
                                    <li onMouseOver={() => setCurrTour("International")} className='hover:text-[#FBAD17] flex cursor-pointer items-center py-5 justify-between px-2 py-1 text-black rounded'>
                                        <a href='#'>International</a>
                                        <IoIosArrowForward className='ms-5' />
                                    </li>
                                    <li onMouseOver={() => setCurrTour("Domestic")} className='hover:text-[#FBAD17] flex items-center cursor-pointer py-5 justify-between px-2 py-1 text-black rounded'>
                                        <a href='#'>Domestic</a>
                                        <IoIosArrowForward className='ms-5' />
                                    </li>
                                </ul>

                                <div className={`bg-white flex flex-col flex-wrap ${currTour === "International" ? "" : "w-0 overflow-hidden"}`}>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Dubai</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Thailand</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Turkey</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2 '>Malaysia</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Baku</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Singapore</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Sri Lanka</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>Maldives</p>
                                </div>
                                <div className={`bg-white flex flex-col flex-wrap ${currTour === "Domestic" ? "" : "w-0 overflow-hidden"}`}>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>North</p>
                                    <p className='mx-8 cursor-pointer hover:text-[#FBAD17] my-2'>South</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p className='cursor-pointer font-bold'>Car Rental</p>
                    <p className='cursor-pointer font-bold'>Visa</p>
                    <div onMouseOver={() => setShowPackageDropdown(true)} className='cursor-pointer font-bold relative' >
                        <p  >Packages</p>
                        <div onMouseOut={() => setShowPackageDropdown(false)} className={` ${showPackageDropdown ? "" : "w-0 overflow-hidden"} expansion absolute z-[100] top-[40px] left-[-5px]`}>
                            <div className=' bg-white flex rounded mt-8 py-2 px-4 shadow-md'>
                                <ul>
                                    <li onMouseOver={() => setCurrTour("International")} className='hover:text-[#FBAD17] flex cursor-pointer items-center py-2 justify-between px-2 py-1 text-black rounded'>
                                        <a href='#'>Group</a>
                                    </li>
                                    <li onMouseOver={() => setCurrTour("Domestic")} className='hover:text-[#FBAD17] flex items-center cursor-pointer py-2 justify-between px-2 py-1 text-black rounded'>
                                        <a href='#'>Honeymoon</a>
                                    </li>
                                    <li onMouseOver={() => setCurrTour("Domestic")} className='hover:text-[#FBAD17] flex items-center cursor-pointer py-2 justify-between px-2 py-1 text-black rounded'>
