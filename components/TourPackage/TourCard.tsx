    ...
    >
      <div className=" w-full relative">
        ...
        <div className="absolute z-10 flex flex-row justify-between w-full">
          <p
            className={`bg-${color}-500 text-white text-sm px-2 py-[2px] m-2 rounded-md`}
          >
            Featured
          </p>
          <div className="flex flex-row gap-2">
            ...
            <div
              className={`flex flex-row gap-2 bg-${color}-500 text-white m-2 px-2 py-[2px] rounded-md`}
            >
      ...
      <div className="flex flex-col gap-2 h-full w-full bg-white px-5 rounded-lg py-5 mt-[12.5rem] ">
        ...
        <div className="flex flex-row gap-2">
          ...
          <p className={`text-xs text-${color}-500 font-semibold`}>
            Rs{dprice}
          </p>
